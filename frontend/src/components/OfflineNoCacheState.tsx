...
export function OfflineNoCacheState() {
  return (
    <div className="flex min-h-[50vh] items-center justify-center px-2xl py-4xl">
      <div className="max-w-md rounded-3xl border border-border-subtle bg-surface-section px-2xl py-4xl text-center">
        ...
        <h1 className="font-heading text-2xl font-bold text-text-primary">No saved data yet</h1>
        <p className="pt-md text-sm leading-5 text-text-secondary">
          YeetCraft needs one successful online visit before it can show saved stats offline.
