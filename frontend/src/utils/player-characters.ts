import { PLAYERS_BY_KEY, type PlayerCharacter, type PlayerRole } from '../data/player-characters'
 ...
 */
export function getRegistryPlayerKey(displayName: string | null | undefined): string | undefined {
