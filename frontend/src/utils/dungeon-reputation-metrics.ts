...
export const DUNGEON_REPUTATION_METRICS = [
  {
    id: 'dangerRating',
    title: 'Danger Rating',
    description: 'How punishing this dungeon is compared to the season average.',
    infoTooltip:
  ...
  },
  {
    id: 'blameShare',
    title: 'Blame Share',
    description: "How much one player is responsible for this dungeon's mistakes.",
    infoTooltip:
      "Top player's share of mistakes here\n\n- Near 0 means blame is spread out\n- 50 is average\n- Near 100 means one player caused most of it.",
  },
] as const

export type DungeonReputationMetricId = (typeof DUNGEON_REPUTATION_METRICS)[number]['id']
